...
export const LightToDarkThemeIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="36"
    height="36"
...
export const DarkToLightThemeIcon = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="36"
    height="36"
...
export const DownloadArrow = ({ className, ...rest }) => (
  ...
  >
    <g
      ...
      strokeWidth={2}
    >
      <path id="bottom_line" strokeDasharray={20} strokeDashoffset={20} d="M3 21h18">
        <animate
          fill="freeze"
          attributeName="stroke-dashoffset"
          dur="0.3s"
      ...
      <path id="top_line" strokeDasharray={15} strokeDashoffset={15} d="M12 3v13.5">
        <animate
          fill="freeze"
          attributeName="stroke-dashoffset"
          begin="0.35s"
      ...
      <path id="arrow_pointer" strokeDasharray={12} strokeDashoffset={12} d="m12 17 7-7m-7 7-7-7">
        <animate
          fill="freeze"
          attributeName="stroke-dashoffset"
          begin="0.65s"
...
export const ArrowDown = ({ className, ...rest }) => (
  ...
  >
    <path
      fill="currentColor"
      d="m11 12.2-.9-.9q-.275-.275-.7-.275t-.7.275q-.275.275-.275.7t.275.7l2.6 2.6q.3.3.7.3t.7-.3l2.6-2.6q.275-.275.275-.7t-.275-.7q-.275-.275-.7-.275t-.7.275l-.9.9V9q0-.425-.288-.713T12 8q-.425 0-.713.288T11 9v3.2Zm1 9.8q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z"
    />
  </svg >
);
...
export const SpainFlag = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={36}
    height={36}
  ...
  >
    ...
    <g fill="#ed4c5c">
      ...
      <path d="M9.7 36.2c-.6 0-1.1-.2-1.1-.5 0-.2.2-.5.6-.7h.6l-.1 1.2m2.3-.9c.4.1.7.2.9.3.1.1-.3.5-.9.8v-1.1" />
    ...
    <g fill="#ed4c5c">
      ...
      <path d="M33.4 36.2c.6 0 1.1-.2 1.1-.5 0-.2-.2-.5-.6-.7h-.6l.1 1.2m-2.3-.9c-.4.1-.7.2-.9.3-.1.1.3.5.9.8v-1.1" />
    ...
    <path
      fill="#c8b100"
      d="M26.4 26.3c-1.2-.7-3-.8-4.9-.8-1.9 0-3.7.2-4.9.8L17 28c1.1.3 2.7.5 4.5.5 1.8 0 3.3-.2 4.5-.5l.4-1.7m1.7-4.3c-.4-.3-1.2-.6-1.9-.6-.3 0-.6 0-.9.1 0 0-.6-.8-2-.8-.5 0-.9.1-1.3.3v-.1c-.1-.2-.3-.4-.5-.4s-.5.3-.5.5v.1c-.4-.2-.8-.3-1.3-.3-1.4 0-2 .9-2 .8-.3-.1-.6-.1-.9-.1-4.6 0-2.3 3.1-2.3 3.1l.5-.6c-1.1-1.4-.1-2.2 1.9-2.2.3 0 .5 0 .7.1-.7 1 .6 1.9.6 1.9l.3-.5c-.7-.5-.8-2.2 1.2-2.2.5 0 .9.1 1.3.4 0 .1-.1 1.5-.2 1.7l.8.7.8-.7c-.1-.3-.2-1.6-.2-1.7.3-.2.8-.4 1.3-.4 2.1 0 2.1 1.7 1.2 2.2l.3.5s1.1-.9.6-1.9c.2 0 .5-.1.7-.1 2.4 0 2.5 1.8 1.9 2.2l.4.6c-.2 0 .9-1.4-.5-2.6"
    />
    <path
      fill="#005bbf"
    ...
    <path
      fill="#fff"
      d="M21.6 45.6c-1.9 0-3.7-.5-5.3-1.2-1.2-.6-1.9-1.7-1.9-3v-4.8h14.4v4.8c0 1.3-.8 2.5-1.9 3-1.6.8-3.4 1.2-5.3 1.2m-.1-17h7.2v8h-7.2z"
    />
    <path
      fill="#ed4c5c"
    ...
    <path
      fill="#ed4c5c"
      d="M28.8 36.6v4.8c0 1.9-1.6 3.4-3.6 3.4s-3.6-1.5-3.6-3.4v-4.8h7.2M26.2 30c.3.6.3 2.1-.6 1.8.2.1.3.8.6 1.2.5.6 1.1.1 1-.6-.2-1.1-.1-1.8.1-2.9 0 .1.5.1.7-.1-.1.3-.2.7 0 .7-.2.3-.7.8-.8 1.1-.1.7 1 2-.2 2.3-.8.2-.3.8 0 1.1 0 0-.4 1.3-.2 1.2-.8.3-.6-.4-.6-.4.4-1.2-.7-1.3-.6-1.5-1-.1.1.9-.8.9-.2 0-.6.2-.6.2-1.1-.1-.5-1.1-.1-1 .3.1.6.6.6-.1 0 0-.5-.8.8-.8-.5 0-.8-.4-1-.9-.2.1-.5.6-1.6.7 0 0-.3-1.1 0-.9.4.2.6.2 1-.2-.2-.3-1.4-.7-1.2-1.4 0-.2.6-.5.6-.5-.1.5.2 1 .8 1 .8.1.5-.2.6-.4.1-.2.7.1.5-.4 0-.1-.7-.2-.5-.5.4-.5 1-.1 1.5.4m-4.6 14.6-.2-.5.2-.6.2.6-.2.5"
    />
    <path
      fill="#c8b100"
      d="M16.5 30.3v.5h.2v.4h-.5v1h.3v2.2h-.6v1.1H20v-1.1h-.5v-2.2h.2v-1h-.5v-.4h.3v-.5h-1v.5h.2v.4h-.5V30h.3v-.5h-1.1v.5h.3v1.2h-.5v-.4h.2v-.5zm11.3 12.3v-5h-5.2v5l2.4 1.1h.3l2.5-1.1M25 38v1.7L23.3 38H25m-2.1.1 2 2-2 2v-4m.2 4.4 1.9-1.9v2.8l-1.9-.9m2.2.8v-2.8l1.9 1.9-1.9.9m2.1-1.2-2-2 2-2v4M25.3 38H27l-1.7 1.7V38"
    />
    <path
      fill="#ed4c5c"
    ...
    <path
      fill="#c8b100"
      d="m20.8 35.2-.4 1.1.3.1-.2.4h.6l-.2-.4.3-.1-.4-1.1m1.5 0-.4 1.1.3.1-.2.4h.6l-.1-.4.3-.1-.5-1.1m-.7 1.3-.5 1.1.3.1-.1.4h.5l-.1-.4.3-.1-.4-1.1"
    />
  </svg>
);

export const UnitedKingdomFlag = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={36}
    height={36}
  ...
  >
    <path
      fill="#2a5f9e"
      d="M22 60.3V46.5l-10.3 7.6c2.9 2.7 6.4 4.8 10.3 6.2m20 0c3.9-1.4 7.4-3.5 10.3-6.2L42 46.4v13.9M3.7 42c.3 1 .7 1.9 1.2 2.9L8.8 42H3.7m51.5 0 3.9 2.9c.4-.9.8-1.9 1.2-2.9h-5.1"
    />
    <path
      fill="#fff"
      d="M23.5 38H2.6c.3 1.4.7 2.7 1.1 4h5.1l-3.9 2.9c.8 1.7 1.7 3.2 2.8 4.7L18 42h4v2l-11.7 8.6 1.4 1.4L22 46.5v13.8c1.3.5 2.6.8 4 1.1V38h-2.5m37.9 0H38v23.4c1.4-.3 2.7-.7 4-1.1V46.5L52.3 54c1.4-1.3 2.6-2.7 3.8-4.2L45.4 42h6.8l6.1 4.5c.3-.5.6-1.1.8-1.6L55.2 42h5.1c.4-1.3.8-2.6 1.1-4"
    />
    <path
      fill="#ed4c5c"
      d="M7.7 49.6c.8 1.1 1.6 2.1 2.5 3.1L22 44.1v-2h-4L7.7 49.6M45.5 42l10.7 7.8c.4-.5.7-1 1.1-1.5.1-.1.1-.2.2-.2.3-.5.7-1.1 1-1.6L52.2 42h-6.7"
    />
    <path
      fill="#2a5f9e"
    ...
    <path
      fill="#fff"
      d="M40.5 26h20.8c-.3-1.4-.7-2.7-1.1-4h-5.1l3.9-2.9c-.8-1.7-1.7-3.2-2.8-4.7L46 22h-4v-2l11.7-8.6-1.4-1.4L42 17.5V3.7c-1.3-.5-2.6-.8-4-1.1V26h2.5M2.6 26H26V2.6c-1.4.3-2.7.7-4 1.1v13.8L11.7 10c-1.4 1.3-2.6 2.7-3.8 4.2L18.6 22h-6.8l-6.1-4.5c-.3.5-.6 1.1-.8 1.6L8.8 22H3.7c-.4 1.3-.8 2.6-1.1 4"
    />
    <g fill="#ed4c5c">
...
export const FranceFlag = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={36}
    height={36}
